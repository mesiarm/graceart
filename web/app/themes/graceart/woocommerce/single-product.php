...
<?php /* PhotoSwipe root for the gallery's expand button. WooCommerce used to print
         this from wp_footer under wc-product-gallery-lightbox support; the theme
         dropped that support to avoid loading its scripts twice, so the root is
         rendered here. The three pswp__item elements are required as-is. */ ?>
    ...
    <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden">
            <div class="pswp__top-bar">
                ...
                <button class="pswp__button pswp__button--close" title="<?php esc_attr_e('Zavrieť (Esc)', 'graceart'); ?>"></button>
                <button class="pswp__button pswp__button--fs" title="<?php esc_attr_e('Celá obrazovka', 'graceart'); ?>"></button>
                <button class="pswp__button pswp__button--zoom" title="<?php esc_attr_e('Priblížiť / oddialiť', 'graceart'); ?>"></button>
            ...
            <button class="pswp__button pswp__button--arrow--left" title="<?php esc_attr_e('Predchádzajúca (šípka vľavo)', 'graceart'); ?>"></button>
            <button class="pswp__button pswp__button--arrow--right" title="<?php esc_attr_e('Ďalšia (šípka vpravo)', 'graceart'); ?>"></button>
