    ...
    <div class="inner">
        <div class="offcanvas-search-form">
            ...
            <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                <div class="row mb-n3">
                    <div class="col-lg-8 col-12 mb-3"><input type="text" name="s" value="<?php echo esc_attr(get_search_query()); ?>" placeholder="<?php esc_attr_e('Hľadať produkty...', 'graceart'); ?>"></div>
                    <div class="col-lg-4 col-12 mb-3">
                        <select name="product_cat" class="search-select select2-basic">
                            <?php echo graceartProductCategoryOptions(sanitize_title(wp_unslash($_GET['product_cat'] ?? ''))); // phpcs:ignore WordPress.Security.NonceVerification.Recommended?>
                        </select>
                    </div>
                </div>
            </form>
        </div>
        <p class="search-description text-body-light mt-2"> <span># <?php esc_html_e('Zadajte aspoň 1 znak pre vyhľadávanie', 'graceart'); ?></span> <span># <?php esc_html_e('Stlačte Enter pre hľadanie alebo ESC pre zatvorenie', 'graceart'); ?></span></p>
